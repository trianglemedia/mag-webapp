...
<html lang="en">
<head>
    <title>Code coverage report for rendr/shared/base/collection.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/shared/base/collection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">rendr/shared/base/</a> &#187; collection.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (modifyInstance == null) {
      modifyInstance = true;
    }
    if (resp != null &amp;&amp; this.jsonKey &amp;&amp; (jsonResp = resp[this.jsonKey])) {
      <span class="missing-if-branch" title="else path not taken"" >E</span>if (modifyInstance) {
...
&nbsp;
    ...
    options.data = options.data || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
