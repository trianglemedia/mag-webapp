...
<html lang="en">
<head>
    <title>Code coverage report for rendr/shared/base/router.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/shared/base/router.js</span></h1>
    <h2>
        
        Statements: <span class="metric">87.65% <small>(71 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">67.86% <small>(19 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">81.25% <small>(13 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">87.65% <small>(71 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">rendr/shared/base/</a> &#187; router.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/*global rendr*/
&nbsp;
...
&nbsp;
  ...
  paths = this.options.paths = this.options.paths || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
BaseRouter.prototype.getRedirect = <span class="fstat-no" title="function not covered" >function(route, params) {</span>
<span class="cstat-no" title="statement not covered" >  var redirect = route.redirect;</span>
<span class="cstat-no" title="statement not covered" >  if (redirect != null) {</span>
    /**
     * Support function and string.
     */
<span class="cstat-no" title="statement not covered" >    if (typeof redirect === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      redirect = redirect(params);</span>
    }
  }
<span class="cstat-no" title="statement not covered" >  return redirect;</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    throw new Error("Error building routes: " + e.stack);</span>
  }
  return this.routes();
};
&nbsp;
 ...
 */
BaseRouter.prototype.defaultHandlerParams = <span class="fstat-no" title="function not covered" >function(viewPath, locals, route) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof viewPath !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >    locals = viewPath;</span>
<span class="cstat-no" title="statement not covered" >    viewPath = route.controller + '/' + route.action;</span>
  }
<span class="cstat-no" title="statement not covered" >  return [viewPath, locals];</span>
};
&nbsp;
/**
