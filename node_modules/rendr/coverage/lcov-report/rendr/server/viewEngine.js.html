...
<html lang="en">
<head>
    <title>Code coverage report for rendr/server/viewEngine.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/server/viewEngine.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">rendr/server/</a> &#187; viewEngine.js</div>
</div>
<div class="body">
...
ViewEngine.prototype.getBootstrappedData = function getBootstrappedData(locals, app) {
  var modelUtils = require('../shared/modelUtils')
    , bootstrappedData = {};
&nbsp;
  _.each(locals, <span class="fstat-no" title="function not covered" >function(modelOrCollection, name) {</span>
<span class="cstat-no" title="statement not covered" >    if (modelUtils.isModel(modelOrCollection) || modelUtils.isCollection(modelOrCollection)) {</span>
<span class="cstat-no" title="statement not covered" >      bootstrappedData[name] = {</span>
