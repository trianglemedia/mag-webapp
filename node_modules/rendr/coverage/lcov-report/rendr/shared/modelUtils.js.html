...
<html lang="en">
<head>
    <title>Code coverage report for rendr/shared/modelUtils.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/shared/modelUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">rendr/shared/</a> &#187; modelUtils.js</div>
</div>
<div class="body">
...
utils.getModel = function(path, attrs, options) {
  var Model;
  attrs = attrs || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
utils.getCollection = function(path, models, options) {
  var Collection;
  models = models || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  options = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
utils.getModelConstructor = function(path) {
  ...
  return classMap[path] || <span class="branch-1 cbranch-no" title="branch not covered" >require(rendr.entryPath + "/app/models/" + path);</span>
};
&nbsp;
utils.getCollectionConstructor = function(path) {
  path = utils.underscorize(path);
  return classMap[path] || <span class="branch-1 cbranch-no" title="branch not covered" >require(rendr.entryPath + "/app/collections/" + path);</span>
};
&nbsp;
utils.getConstructor = <span class="fstat-no" title="function not covered" >function(type, path) {</span>
<span class="cstat-no" title="statement not covered" >  var method;</span>
<span class="cstat-no" title="statement not covered" >  method = type === 'model' ? utils.getModelConstructor : utils.getCollectionConstructor;</span>
<span class="cstat-no" title="statement not covered" >  return method(path);</span>
};
&nbsp;
