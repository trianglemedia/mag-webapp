...
<html lang="en">
<head>
    <title>Code coverage report for rendr/shared/base/model.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/shared/base/model.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">rendr/shared/base/</a> &#187; model.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
  parse: function(resp) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (resp != null &amp;&amp; this.jsonKey) {
