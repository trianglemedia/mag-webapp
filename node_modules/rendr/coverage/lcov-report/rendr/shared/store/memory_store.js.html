...
<html lang="en">
<head>
    <title>Code coverage report for rendr/shared/store/memory_store.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/shared/store/memory_store.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">rendr/shared/store/</a> &#187; memory_store.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">125</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = MemoryStore;
&nbsp;
...
MemoryStore.prototype.set = function(key, value, ttlSec) {
  var expires;
&nbsp;
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (!key || value === undefined) {
