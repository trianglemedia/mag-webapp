...
<html lang="en">
<head>
    <title>Code coverage report for rendr/shared/store/model_store.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">rendr/shared/store/model_store.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">rendr/shared/store/</a> &#187; model_store.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var MemoryStore, Super, modelUtils, _;
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (modelName == null) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Undefined modelName for model');</span>
  }
...
ModelStore.prototype.find = function(modelName, params){
  ...
  foundCachedObject = _.find(this.cache, function(cacheObject, key){
    ...
    // validate subset
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (data &amp;&amp; isObjectSubset(params, data)){
